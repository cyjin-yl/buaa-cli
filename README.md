...
| announcements | College current/historical announcements | implemented-observed-read |
| archive | CDX/Memento historical lookup | implemented-offline-tested + implemented-observed-read |
